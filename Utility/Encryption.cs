...
namespace Utility
{
    public class Encryption
    {
        ...
        //public static string EncryptToURL(string clearText)
        //{
        //    clearText=clearText.TrimEnd(new char[] { '=' }).Replace('+', '-').Replace('/', '_');
        //    return HttpUtility.UrlEncode(Encrypt(clearText));
        //}


        //public static string DecryptFromURL(string cipherText)
        //{
        ...
        //    return Decrypt(HttpUtility.UrlDecode(cipherText));
        //}
